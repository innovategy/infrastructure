...
export default class App {
  ...
  public static readSecrets(scope: Construct): { [key: string]: Secret} {
    return {
      ...
      "LINKEDIN_CLIENT_ID": this.readFromSSM(scope, this.generateSsmKey("app/ouath/linkedin/client-secret")),
      "GITHUB_CLIENT_ID": this.readFromSSM(scope, this.generateSsmKey("app/ouath/github/client-secret")),
