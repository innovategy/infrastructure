...
export class ElasticCacheRedisStack extends cdk.Stack {
  ...
  constructor(scope: cdk.Construct, id: string, securityGroupId: string, vpc: ec2.Vpc, props?: cdk.StackProps) {
    ...
    this.stack = new Redis()
      .inVpc(vpc)
      .inScope(this)
      .addSubnet(AvailabilityZones.euCentral1().a, "10.0.3.0/24", "RedisCachePrivateSubnetZA")
      .addSubnet(AvailabilityZones.euCentral1().b, "10.0.4.0/24", "RedisCachePrivateSubnetZB")
