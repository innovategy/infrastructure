...
export default class App {
  ...
  public static readSecrets(scope: Construct): { [key: string]: Secret} {
    return {
      ...
      "LINKEDIN_CLIENT_SECRET": this.readFromSSM(scope, this.generateSsmKey("app/oauth/linkedin/client-secret")),
      "GITHUB_CLIENT_SECRET": this.readFromSSM(scope, this.generateSsmKey("app/oauth/github/client-secret")),
      ...
      "SQS_PREFIX": this.readFromSSM(scope, this.generateSsmKey('app/sqs/prefix')),
